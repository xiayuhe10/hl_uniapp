<template>
	<view class="uni-swiper__warp">
		...
		<view v-if="mode === 'nav'" key='nav' @click="clickUrl(current)" :style="{'background-color':dotsStyles.backgroundColor,'bottom':'0'}" class="uni-swiper__dots-box uni-swiper__dots-nav">
