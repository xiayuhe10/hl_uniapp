<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick">
		...
		<image style="margin-left: 10rpx; width: 40rpx;height: 40rpx;" src="@/static/index/gundongtongzhi.png"></image>
		<!-- #endif -->
		...
		<view style="color: #7F7F7F; font-size: 26rpx;" v-if="showGetMore === true || showGetMore === 'true'" class="uni-noticebar__more uni-cursor-point" @click="clickMore">
