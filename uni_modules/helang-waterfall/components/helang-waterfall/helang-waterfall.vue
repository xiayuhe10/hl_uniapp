		...
		<view class="content">
			<view class="item bg-white padding ">
				...
				<view class="grid col-2 text-xs margin-top-xs">
					...
					<view @click="publish(params.id)" v-if="params.status==0" class=" text-xs response margin-top-xs">
						<view
							class=' radius bg-white solid flex justify-between align-center padding-tb-xs padding-lr-sm'>
